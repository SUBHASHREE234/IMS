...
const AdminPanel = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="buyer-form-container" style={{ position: "relative" }}>
          <span> LETS GET STARTED</span>
          <h3>Create An Account</h3>
          <br />
          <RxCrossCircled className="buyer-form-cross" onClick={handleClose} />
          <form onSubmit={handleSubmit}>
            ...
            <div className="data-input-fields" id="eye-id">
              ...
              />
              {
                look1?<PiEyeLight className="eye" onClick={()=>setLook1(false)}/>:<PiEyeSlashLight className="eye" onClick={()=>setLook1(true)}/>
              }
            </div>
            <div className="data-input-fields" id="eye-id">
              <TextField
              ...
              />
              {
                look2?<PiEyeLight className="eye" onClick={()=>setLook2(false)}/>:<PiEyeSlashLight className="eye" onClick={()=>setLook2(true)}/>
              }
            </div>
